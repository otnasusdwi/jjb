...
<div class="container-fluid">
    ...
    <div class="page-title-box mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="page-title mb-1">Add New Package</h4>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" min="1" max="30"
                                                   ...
                                                   id="duration_days" name="duration_days" value="{{ old('duration_days', 1) }}" required>
                                            @error('duration_days')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" min="0" max="30"
                                                   ...
                                                   id="duration_nights" name="duration_nights" value="{{ old('duration_nights', 0) }}">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body text-center">
                                ...
                                <input type="file" class="form-control @error('featured_image') is-invalid @enderror"
                                       id="featured_image" name="featured_image" accept="image/*" onchange="openCropModal(event, 'featured')">
...
function addGalleryImage() {
    ...
    const imageHtml = `
        <div class="border rounded p-3 mb-3" id="gallery-${galleryCounter}">
            ...
            <input type="file" class="form-control form-control-sm gallery-file-input" 
...
document.addEventListener('DOMContentLoaded', function() {
    // Don't auto-add items, let user add them manually
    // addItineraryDay();
    // addInclusion();
    // addExclusion();
});
...
<script>
let cropper = null;
let currentCropType = null; // 'featured' or 'gallery'
...
function openCropModal(event, type, galleryId = null) {
    ...
    reader.onload = function(e) {
        ...
        // Initialize cropper with free aspect ratio by default
