...
@section('title', isset($heroBanner) ? 'Edit Hero Banner' : 'Create Hero Banner')
...
<div class="container-fluid">
    ...
    <div class="page-title-box mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="page-title mb-1">{{ isset($heroBanner) ? 'Edit Hero Banner' : 'Create Hero Banner' }}</h4>
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.hero-banners.index') }}">Hero Banners</a></li>
                    <li class="breadcrumb-item active">{{ isset($heroBanner) ? 'Edit' : 'Create' }}</li>
                </ol>
            </div>
            <div class="col-md-4">
                <div class="float-end">
    ...
    @if ($errors->any())
        <div class="alert alert-danger alert-dismissible fade show mb-4" role="alert">
            <h5 class="alert-heading">
                <i class="ri-alert-fill me-2"></i> Validation Errors
            </h5>
            <ul class="mb-0">
    ...
    <form action="{{ isset($heroBanner) ? route('admin.hero-banners.update', $heroBanner) : route('admin.hero-banners.store') }}" method="POST" enctype="multipart/form-data" id="bannerForm">
        @csrf
        @if(isset($heroBanner))
            @method('PUT')
        @endif
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('order') is-invalid @enderror"
                                   id="order" name="order" value="{{ old('order', $heroBanner->order ?? 0) }}" min="0">
                            @error('order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="ri-save-line me-1"></i> {{ isset($heroBanner) ? 'Update' : 'Create' }} Banner
                        </button>
                    </div>
                </div>
            </div>
